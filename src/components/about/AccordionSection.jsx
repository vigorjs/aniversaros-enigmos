        ...
        <div className='flex flex-col lg:flex-row justify-between items-center w-full px-2 md:px-4 lg:px-8 xl:px-0 lg:max-w-7xl mx-auto space-x-0 lg:space-x-3'>
            ...
            <div className='w-full px-4 lg:w-1/2 pt-10'>
                <div className="flex-1 space-y-4 sm:space-y-6">
                    ...
                    <p className="font-light">Enigma Camp (PT Enigma Cipta Humanika) mengkhususkan diri dalam bisnis IT Bootcamp dan IT Talent Management, dan resmi didirikan pada 19 Agustus 2019. Enigma Camp didorong oleh pengalaman yang membangun insinyur perangkat lunak untuk mendukung bisnis klien kami.</p>
                </div>
                <Accordion type="single" collapsible className="w-full" defaultValue="item-1">
                    <AccordionItem value="item-1">
                        <AccordionTrigger>
                            <p className="sm:text-md text-slate-800"><span className="font-bold text-xl">R</span>espect</p>
                        </AccordionTrigger>
                        <AccordionContent>
                    ...
                    <AccordionItem value="item-2">
                        <AccordionTrigger>
                            <p className="text-md text-slate-800"><span className="font-bold text-xl">E</span>ffective & Efficient</p>
                        </AccordionTrigger>
                        <AccordionContent>
                    ...
                    <AccordionItem value="item-3">
                        <AccordionTrigger>
                            <p className="text-md text-slate-800"><span className="font-bold text-xl">A</span>gile Spirit</p>
                        </AccordionTrigger>
                        <AccordionContent>
                    ...
                    <AccordionItem value="item-4">
                        <AccordionTrigger>
                            <p className="text-md text-slate-800"><span className="font-bold text-xl">D</span>iscipline</p>
                        </AccordionTrigger>
                        <AccordionContent>
                    ...
                    <AccordionItem value="item-5">
                        <AccordionTrigger>
                            <p className="text-md text-slate-800"><span className="font-bold text-xl">Y</span>es I Can</p>
                        </AccordionTrigger>
                        <AccordionContent>
